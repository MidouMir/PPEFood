package comic.systems.ppefood.adapter;
...
import comic.systems.ppefood.R;
import comic.systems.ppefood.helper.CircleTransform;
import comic.systems.ppefood.helper.FlipAnimator;
import comic.systems.ppefood.model.PanierModele;

public class MessagesAdapter extends RecyclerView.Adapter<MessagesAdapter.MyViewHolder> {
    private Context mContext;
    private List<PanierModele> messages;
    ...
    public MessagesAdapter(Context mContext, List<PanierModele> messages, MessageAdapterListener listener) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_panier, parent, false);
    ...
    private void applyImportant(MyViewHolder holder, PanierModele message) {
        /*if (message.isImportant()) {*/
            holder.iconImp.setImageDrawable(ContextCompat.getDrawable(mContext, R.drawable.moins));
